...
consignes.md
8 Ko
ORAL 30 AVRIL --> L'aprem
lena5013 — 09:36
https://github.com/lenaa00/ProjetTransversalPOO.git
GitHub
lenaa00/ProjetTransversalPOO
Contribute to lenaa00/ProjetTransversalPOO development by creating an account on GitHub.
Contribute to lenaa00/ProjetTransversalPOO development by creating an account on GitHub.
Katia’ — 09:36
pour le hashage du mot de passe, on compare le premier hashage lors de la premiere authentification et quand il se reconnecte on hashe le mot de passe qu'il rempli et on compare si le hashage est le meme
PROJET TRANSVERSAL POO
Il faudra expliquer le jour de l'oral les règles qu'on a donné à la robustesse du mot de passe et pk
message non lu
conversation = utilisateur => utilisateur
penser héritage et polymorphisme
veut des tests poussés et complet => tests unitaires, documenter les test (il est bien crypté du début à la fin)
Documenter les test
documentation claire => si on prend SQL ou No SQL pk, la bibliothèque
Penser planing trello
Readme.md
﻿
# Messagerie sécurisée 🔐
